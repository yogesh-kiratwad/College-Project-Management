...
<ul>
    ...
    <li><a class="a" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> Add Teacher Data</a></li>
...
<div class="cont">
	<div class="registration">
		<h2><i class="fa fa-user-plus" aria-hidden="true"></i> Add Teacher Data</h2>
	</div>
	
	<form action="server_teacher.php" method="post">
		...
		<div class="teacher_bday_box">
				...
				<div class="input-group" style="margin: 0px; padding: 10px;">
					<span class="p_font" style="float: left; margin-left:10px; margin-top: 10px;">Teacher's qualification: </span>
					<div class="select_style" style="height: 50px; border-left-width: 1px;; margin-left: 10px; width:90px; margin-right:60px;">
    					<select name="degree">
			    ...
			    <div class="input-group-btn">
					<input type="submit" name="btn-sub" value="Submit">
				</div>
